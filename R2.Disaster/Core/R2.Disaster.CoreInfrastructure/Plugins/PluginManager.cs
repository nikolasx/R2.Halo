...
using R2.Disaster.Core.Plugins;
using Nop.Core;
using R2.Disaster.Core.ComponentModel;
...
namespace R2.Disaster.Core.Plugins
{
    /// <summary>
    ...
    public class PluginManager
    {
        ...
        private const string PluginsPath = "~/Apps";
        private const string ShadowCopyPath = "~/Apps/bin";
        ...
        private static bool IsPackagePluginFolder(DirectoryInfo folder)
        {
            ...
            if (!folder.Parent.Name.Equals("Apps", StringComparison.InvariantCultureIgnoreCase)) return false;
            return true;
        }
