...
{
    public class LandCollapseMap : EntityTypeConfiguration<LandCollapse>
    {
        public LandCollapseMap()
        {
            this.ToTable("LandCollapses");
            this.HasKey(c => c.Id);
            ...
            //    .WithRequiredDependent(c => c.LandCollapse);
        }
    }
}
