...
var warningResultAnalysis = {
    ...
    content:'<div class="warBox">'+
                      ...
                      '<div class="wraResultBox" style="height:50px;">' +
                            ...
                            '<div id="btnMarkybc" class="wraButton">制作预报词</div>' +
                      ...
                      '<div class="wraResultBox" style="height:95px;">' +
                            ...
                            '<div class="wrafb" id="xzdjbfb">乡镇等级表</div>' +
                            '<div class="wrafb" id="xqdjbfb">等级表+图</div>' +
                            '<div id="createJpg" class="wrafbJpgdisable">产品发布</div>' +
                            '<div id="scanJpg" class="wrafbJpgdisable">产品预览</div>' +
